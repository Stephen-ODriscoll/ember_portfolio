...
module('Acceptance | portfolio test', function(hooks) {
  ...
  test('visiting /portfolio-test', async function(assert) {
    await visit('/portfolio-test');

    assert.equal(currentURL(), '/portfolio-test');
  });
});
